...
# Совместимость
- мод должен быть технически совместим с будущими версиями X-piratez, пока в них остаются ресурсы: STR_SOLDIER_NEKOMIMI_O (Outlaw Catgirl), STR_NEKO_UNIPUMA (Unipuma Uniform) и несколько других (например, музыка DTPDANCE). 
